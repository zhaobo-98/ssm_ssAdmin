...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/room/updateRoom" id="roomForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		    	...
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">宿舍楼：
							<select disabled name="dormitory.dorId" id="roomDorId">
									<option value="${rooms.dormitory.dorId}">${rooms.dormitory.dorName}</option>
							</select>
						</td>
		    			<td class="font3 fftd">宿舍编号：<input type="text" name="roomName" id="roomName" size="20" value="${rooms.roomName}"/></td>
		    		</tr>
